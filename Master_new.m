function [Rating, Cache, Bandwidth, Mean, lenD, Rmean, Rvar, DownRate, cP, StarveCnt, runCnt] = Master_new(maxl, Data, ServeTime, Group, c, CacheSize, StartDelay, TimeSlot, W, P, Segmentlen)
...
while(1)
    ...
    if (mod(CurrentTime, CalcTime) < eps)
        ...
        while(1)
            ...
            [r, r0] = Step2_Diff(U(1 : p, :), p, LL(1 : q, :), q, Buffer, SerTag, maxl, R, lenR, W, Group, CalcTime, c, P, alpha, StartDelay, Rating(:, nowSl - 1), lack, GetR, Segmentlen, Para); %Step2
